...
import { Sun, Cloud, Rain, Snow, Wind, Menu, X } from "lucide-react";
  ...
  return (
    <div
      className={`bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-4 ${
        isSearched ? " border-2 bg-gradient-to-r from-gray-800 to-neutral-900 rounded-lg hover:scale-105 transition duration-500" : ""
      }`}
    >
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 to-gray-700 text-white">
      <div className="bg-gray-500 bg-opacity-20 backdrop-blur-lg rounded-lg p-8 w-full max-w-4xl">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-bold lg:pl-44 md:pl-52">Weather Around the World</h1>
          <button
            className="md:hidden"
        ...
        <div
          ...
          } md:block mb-8 bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-4`}
        >
